...
class Login
{
    ...
    private $user_email = "";
    /**
     * @var string $user_uid The user's hf uid
     */
    private $user_uid = "";
    /**
     * @var string $user_current_challenge The user's current challenge
     */
    private $user_current_challenge = "";
    /**
    ...
    public function editUserName($user_name)
    {
        ...
        $this->errors[] = 'This is disabled for now';
        return false;
